...
test('correctn todolist should be removed', () => {
    ...
    const endState = TodolistReducer(startState, removeTodolistAC({todolistId: '2'})) 
...
test ('correct todolist should be added', () => {
    ...
    const endState = TodolistReducer(startState, addTodolistAC({todolist: todo}))
...
test ('correct todolist sould change title', () => {
    ...
    const endState = TodolistReducer(startState, changeTodolistTitleAC({todolistId: '1', title: 'SUPER TEST'}))
